...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  ReactDOM.render(React.createElement(Game, null), document.getElementById('jezz-game'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	BallStore.reset = function (ballCount) {
	  ...
	  for (var i = 0; i < ballCount; i++) {
	    ...
	    _balls.push(new Ball(randomX, randomY, angle));
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Segment.prototype.draw = function (ctx) {
	  ...
	  ctx.fillRect(vertices.topLeftX, vertices.topLeftY, vertices.bottomRightX - vertices.topLeftX, vertices.bottomRightY - vertices.topLeftY);
	...
	Segment.prototype.vertices = function () {
	  ...
	  var toDrawCoords = this.startCoord.x < this.endCoord.x || this.startCoord.y < this.endCoord.y ? {
	...
	Segment.prototype.distanceCheck = function (point) {
	  ...
	  [{
	    ...
	    var dist = MathUtil.pDistance(pX, pY, s.x1, s.y1, s.x2, s.y2);
...
/***/ function(module, exports) {
	...
	exports.distanceCircleToSegment = function (circle, segment) {
	  ...
	  return exports.pDistance(circle.posX, circle.posY, segment.startX, segment.startY, segment.endX, segment.endY);
	};
